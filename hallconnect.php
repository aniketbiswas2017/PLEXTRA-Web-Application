				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="home-content"><br><br><br><br><br><br><br>
							<h1>List of all movie theatres near you</h1>
						</div>
					</div>
				</div>
			</div>
...
<div id="speakers" class="section">
		<div class="container">
			<div class="row">
				...
				<h4 class="title"><span>&nbsp;&nbsp;Select hall for viewing movie</span></h4>
				</div>
		<?php
echo "<table style='border: solid 1px black;'>";
 echo "<tr><th>ID</th><th> Hall Name</th><th> Location</th></tr>";
...
try {
    ...
    $stmt = $conn->prepare("SELECT hall_id, hall_name, location FROM hall"); 
    $stmt->execute();
...
<br>
<div class="dropup">
    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Select Theatre
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <li><a href="seatselect.html">Cineplex Cinemas Park Lane</a></li>
      <li><a href="#">Scotiabank Theatre Halifax</a></li>
      <li><a href="#">Cineplex Cinemas Dartmouth Crossing</a></li>
	  <li><a href="#">Cineplex Cinemas Lower Sackville</a></li>
    </ul>
 </div>
			</div>
		</div>
